...
class Upload
{
    ...
    public function save()
    {
        ...
        if (!in_array($ext, $this->allowedExts)) {
            throw new Exception("Invalid file type. Allowed: " . implode(', ', $this->allowedExts)); // Example: "Invalid file type. Allowed: jpg, png"
        }

        // Validate file size
        if ($filesize > $this->maxSize) {
            throw new Exception("File size exceeds maximum allowed: " . $this->maxSize);
        }

        // 3. Save the file to the destination folder
        // __DIR__ gives the directory of the current file e.g. "C:/xampp/htdocs/Project_2_MySQLi/app/models/"
        $fullDest = __DIR__ . "/../../public/" . $this->destination; // Full path to the destination folder e.g. "C:/xampp/htdocs/Project_2_MySQLi/public/uploads/img/"
        ...
        $destination = $fullDest . $newFilename; // Full path to save the file e.g. "C:/xampp/htdocs/Project_2_MySQLi/public/uploads/img/user_5f2c9e8a7b3a1.jpg"
        ...
        // 4. Return the URL of the saved file (e.g. "uploads/img/user_5f2c9e8a7b3a1.jpg")
